...
{id:"csr",name:"Chase Sapphire Reserve",short:"Sapphire Reserve",issuer:"Chase",isBiz:false,fee:795,network:"Visa",cur:"Chase Ultimate Rewards",c1:"#1a1a2e",c2:"#4a3728",
 ...
 annual:[{n:"$300 Travel Credit",v:300,d:"Auto-applied to ANY travel — Uber, parking, tolls, Airbnb, rental cars. Very broad.",cat:"travel",reset:"annual",enroll:false,enrollUrl:"",useUrl:""},{n:"Global Entry/TSA PreCheck",v:100,d:"Reimburses app fee every 4 years.",cat:"travel",reset:"annual",enroll:false,enrollUrl:"",useUrl:""},{n:"Priority Pass Lounge",v:null,d:"Unlimited visits + 2 guests at 1,400+ lounges worldwide.",cat:"status",reset:"annual",enroll:false,enrollUrl:"",useUrl:""}],
 monthly:[{n:"DoorDash Credit",v:5,d:"$5/month DoorDash credit + complimentary DashPass. Expires monthly!",cat:"dining",reset:"monthly",enroll:false,enrollUrl:"",useUrl:""}],
...
{id:"csp",name:"Chase Sapphire Preferred",short:"Sapphire Preferred",issuer:"Chase",isBiz:false,fee:95,network:"Visa",cur:"Chase Ultimate Rewards",c1:"#1a3a5c",c2:"#0f2236",
 partners:["Hyatt","United","Southwest","Singapore Airlines","Air France/KLM","British Airways","Virgin Atlantic","Marriott","Iberia","Emirates","Air Canada"],
 annual:[{n:"$50 Hotel Credit",v:50,d:"$50 on hotel stays via Chase Travel portal annually.",cat:"travel",reset:"annual",enroll:false,enrollUrl:"",useUrl:""}],
...
{id:"hyatt",name:"World of Hyatt Card",short:"Hyatt Card",issuer:"Chase",isBiz:false,fee:95,network:"Visa",cur:"Hyatt Points",c1:"#1a1a1a",c2:"#2d1a3a",
 ...
 annual:[{n:"Free Night Award",v:150,d:"1 free night at any Category 1–4 Hyatt property each year.",cat:"awards",reset:"annual",enroll:false,enrollUrl:"",useUrl:""},{n:"Discoverist Status",v:null,d:"Automatic Discoverist — early check-in, late checkout, bonus points.",cat:"status",reset:"annual",enroll:false,enrollUrl:"",useUrl:""}],
...
{id:"sw-priority",name:"Southwest Rapid Rewards® Priority",short:"SW Priority",issuer:"Chase",isBiz:false,fee:229,network:"Visa",cur:"Southwest Rapid Rewards",c1:"#304CB2",c2:"#cc0000",
 annual:[{n:"$75 Annual Travel Credit",v:75,d:"$75 in Southwest travel credits automatically applied.",cat:"travel",reset:"annual",enroll:false,enrollUrl:"",useUrl:""},{n:"4 Upgraded Boardings",v:40,d:"4 A1–A15 upgraded boarding positions per year.",cat:"travel",reset:"annual",enroll:false,enrollUrl:"",useUrl:""},{n:"7,500 Anniversary Points",v:112,d:"7,500 points each anniversary worth ~$112 in SW flights.",cat:"awards",reset:"annual",enroll:false,enrollUrl:"",useUrl:""}],
...
{id:"united-explorer",name:"United℠ Explorer Card",short:"United Explorer",issuer:"Chase",isBiz:false,fee:95,network:"Visa",cur:"United MileagePlus",c1:"#002244",c2:"#001133",
 annual:[{n:"Free Checked Bag",v:35,d:"First bag free for you + companion on United flights.",cat:"travel",reset:"annual",enroll:false,enrollUrl:"",useUrl:""},{n:"2 United Club Passes",v:100,d:"Two single-visit United Club passes annually.",cat:"status",reset:"annual",enroll:false,enrollUrl:"",useUrl:""}],
...
{id:"ihg-premier",name:"IHG One Rewards Premier",short:"IHG Premier",issuer:"Chase",isBiz:false,fee:99,network:"Visa",cur:"IHG One Rewards Points",c1:"#006747",c2:"#004d35",
 annual:[{n:"Annual Free Night",v:100,d:"Free night at IHG properties annually — up to 40,000 pts value.",cat:"awards",reset:"annual",enroll:false,enrollUrl:"",useUrl:""},{n:"IHG Platinum Elite",v:null,d:"Automatic Platinum Elite status — 60% bonus points.",cat:"status",reset:"annual",enroll:false,enrollUrl:"",useUrl:""}],
...
{id:"amex-plat",name:"The Platinum Card® from American Express",short:"Amex Platinum",issuer:"American Express",isBiz:false,fee:895,network:"Amex",cur:"Amex Membership Rewards",c1:"#1c1c1c",c2:"#4a4a4a",
 ...
 annual:[
  {n:"$200 Airline Fee Credit",v:200,d:"Select ONE airline. Covers incidental fees (bags, upgrades). Must select your airline!",cat:"travel",reset:"annual",enroll:true,enrollUrl:"",useUrl:""},
  {n:"$200 Hotel Credit",v:200,d:"Prepaid hotels via Amex Fine Hotels+Resorts. Also includes breakfast, upgrades, $100 property credit.",cat:"travel",reset:"annual",enroll:false,enrollUrl:"",useUrl:""},
  {n:"$240 Digital Entertainment",v:240,d:"$20/month for Disney+, Hulu, ESPN+, Peacock, NYT, Audible, etc.",cat:"entertainment",reset:"annual",enroll:false,enrollUrl:"",useUrl:""},
  {n:"$155 Walmart+ Credit",v:155,d:"$12.95/month — covers the full Walmart+ membership (Paramount+ included).",cat:"statement",reset:"annual",enroll:false,enrollUrl:"",useUrl:""},
  {n:"$100 Saks Credit",v:100,d:"$50 Jan–June, $50 July–Dec at Saks Fifth Avenue or Saks OFF 5TH.",cat:"statement",reset:"semi-annual",enroll:false,enrollUrl:"",useUrl:""},
  {n:"Global Entry/TSA PreCheck",v:100,d:"Application fee reimbursed every 4–4.5 years.",cat:"travel",reset:"annual",enroll:false,enrollUrl:"",useUrl:""},
  {n:"Centurion Lounge Access",v:null,d:"Unlimited access to Amex Centurion Lounges + Priority Pass + Delta Sky Club (10 visits/year; unlimited with $75k annual spend).",cat:"status",reset:"annual",enroll:false,enrollUrl:"",useUrl:""},
 ],
 monthly:[{n:"$15 Uber Cash",v:15,d:"$15 in Uber Cash/month ($20 in December). Expires at month end — most forgotten benefit!",cat:"statement",reset:"monthly",enroll:false,enrollUrl:"",useUrl:""},{n:"$20 Digital Entertainment",v:20,d:"$20/month for eligible streaming.",cat:"entertainment",reset:"monthly",enroll:false,enrollUrl:"",useUrl:""}],
...
{id:"amex-gold",name:"American Express® Gold Card",short:"Amex Gold",issuer:"American Express",isBiz:false,fee:325,network:"Amex",cur:"Amex Membership Rewards",c1:"#8B6914",c2:"#5c4411",
 partners:["Air France/KLM Flying Blue","ANA","British Airways","Avianca LifeMiles","Cathay Pacific","Delta","Singapore Airlines","Virgin Atlantic","Hilton","Marriott"],
 annual:[],
 monthly:[{n:"$10 Dining Credit",v:10,d:"At Grubhub, Cheesecake Factory, Goldbelly, Wine.com, Five Guys. Must enroll!",cat:"dining",reset:"monthly",enroll:true,enrollUrl:"",useUrl:""},{n:"$10 Uber Cash",v:10,d:"For Uber rides or Uber Eats. Expires monthly!",cat:"statement",reset:"monthly",enroll:false,enrollUrl:"",useUrl:""}],
...
{id:"hilton-aspire",name:"Hilton Honors American Express Aspire Card",short:"Hilton Aspire",issuer:"American Express",isBiz:false,fee:550,network:"Amex",cur:"Hilton Honors Points",c1:"#1a3a6e",c2:"#0f2244",
 annual:[{n:"$200 Hilton Resort Credit (1st half)",v:200,d:"$200 at Hilton resorts Jan–Jun for food, spa, activities.",cat:"travel",reset:"semi-annual",enroll:false,enrollUrl:"",useUrl:""},{n:"$200 Hilton Resort Credit (2nd half)",v:200,d:"$200 at Hilton resorts Jul–Dec.",cat:"travel",reset:"semi-annual",enroll:false,enrollUrl:"",useUrl:""},{n:"$200 Flight Credit",v:200,d:"$200 annually toward flight purchases.",cat:"travel",reset:"annual",enroll:false,enrollUrl:"",useUrl:""},{n:"Free Weekend Night",v:200,d:"1 free weekend night award each year at any Hilton.",cat:"awards",reset:"annual",enroll:false,enrollUrl:"",useUrl:""},{n:"Diamond Status",v:null,d:"Automatic Diamond — complimentary breakfast, lounge access, upgrades.",cat:"status",reset:"annual",enroll:false,enrollUrl:"",useUrl:""}],
...
{id:"delta-gold",name:"Delta SkyMiles® Gold American Express Card",short:"Delta Gold",issuer:"American Express",isBiz:false,fee:150,network:"Amex",cur:"Delta SkyMiles",c1:"#c8000a",c2:"#8B0006",
 annual:[{n:"$200 Delta Flight Credit",v:200,d:"$200 Delta flight credit after $10k annual spend.",cat:"travel",reset:"annual",enroll:false,enrollUrl:"",useUrl:""},{n:"Free Checked Bag",v:35,d:"First checked bag free for you + up to 8 companions.",cat:"travel",reset:"annual",enroll:false,enrollUrl:"",useUrl:""}],
...
{id:"venture-x",name:"Capital One Venture X Rewards Credit Card",short:"Venture X",issuer:"Capital One",isBiz:false,fee:395,network:"Visa",cur:"Capital One Miles",c1:"#8B1010",c2:"#5c0808",
 ...
 annual:[{n:"$300 Travel Credit",v:300,d:"$300 annual credit on Capital One Travel portal bookings.",cat:"travel",reset:"annual",enroll:false,enrollUrl:"",useUrl:""},{n:"10,000 Anniversary Miles",v:100,d:"10,000 bonus miles each account anniversary — worth $100 in travel.",cat:"awards",reset:"annual",enroll:false,enrollUrl:"",useUrl:""}],
...
{id:"ink-preferred",name:"Ink Business Preferred® Credit Card",short:"Ink Preferred",issuer:"Chase",isBiz:true,fee:95,network:"Visa",cur:"Chase Ultimate Rewards",c1:"#1a3a6e",c2:"#0f2244",
 ...
 annual:[],monthly:[],strat:["ink-trio"],signup:"100,000 pts after $8k in 3 mo",
...
{id:"amex-biz-plat",name:"The Business Platinum Card® from American Express",short:"Amex Business Platinum",issuer:"American Express",isBiz:true,fee:695,network:"Amex",cur:"Amex Membership Rewards",c1:"#1c1c1c",c2:"#3a3520",
 partners:["Air France/KLM Flying Blue","ANA","British Airways","Avianca LifeMiles","Cathay Pacific","Delta","Singapore Airlines","Virgin Atlantic","Hilton","Marriott"],
 annual:[{n:"$400 Dell Credit",v:400,d:"$200 Jan–Jun, $200 Jul–Dec at Dell Technologies.",cat:"statement",reset:"semi-annual",enroll:false,enrollUrl:"",useUrl:""},{n:"$360 Indeed Credit",v:360,d:"$90/quarter in Indeed recruiting credits.",cat:"statement",reset:"annual",enroll:false,enrollUrl:"",useUrl:""},{n:"$150 Adobe Credit",v:150,d:"$150/year for Adobe Creative Cloud.",cat:"statement",reset:"annual",enroll:false,enrollUrl:"",useUrl:""},{n:"$120 Wireless Credit",v:120,d:"$10/month for wireless phone plan.",cat:"statement",reset:"annual",enroll:false,enrollUrl:"",useUrl:""}],
 monthly:[],strat:[],signup:"150,000 pts after $20k in 3 mo",
...
{id:"marriott-brilliant",name:"Marriott Bonvoy Brilliant® American Express® Card",short:"Marriott Brilliant",issuer:"American Express",isBiz:false,fee:650,network:"Amex",cur:"Marriott Bonvoy Points",c1:"#5c0f0f",c2:"#3a0808",
 partners:["Marriott Bonvoy"],
 annual:[{n:"$300 Marriott Dining Credit",v:300,d:"$25/month at restaurants worldwide.",cat:"dining",reset:"annual",enroll:false,enrollUrl:"",useUrl:""},{n:"Free Night Award",v:450,d:"1 free night at properties up to 85,000 Bonvoy points.",cat:"awards",reset:"annual",enroll:false,enrollUrl:"",useUrl:""},{n:"Platinum Elite Status",v:null,d:"Automatic Platinum Elite — suite upgrades, lounge access, breakfast.",cat:"status",reset:"annual",enroll:false,enrollUrl:"",useUrl:""}],
