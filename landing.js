// landing.js — FeeWorth marketing landing page for unauthenticated visitors
//
// Self-contained React component with all markup for the landing page.
// Styles live in landing.css. This file is loaded via <script type="text/babel">
// so Babel Standalone transpiles the JSX at runtime.
//
...
// Small SVG icon helper scoped to the landing page.
// Uses the same 24x24 / 1.5 stroke convention as the main app.
...
// Checkmark icon used in feature bullet lists
const LpCheck = () => (
      ...
      <section className="lp-hero">
        <div className="lp-container">
          <div className="lp-hero-text">
            ...
            <h1>Is the fee <em>worth it?</em></h1>
      ...
      <section className="lp-features">
        <div className="lp-container">
            ...
            <div className="lp-feature-visual">
              <div className="lp-feature-screenshot">
                ...
                <div className="lp-bt-row">
                  <div className="lp-bt-check lp-bt-check-on"></div>
                  <div className="lp-bt-name">$300 Travel Credit</div>
                  <span className="lp-bt-tag lp-bt-tag-travel">Travel</span>
                  <div className="lp-bt-value">$300/yr</div>
                </div>
                <div className="lp-bt-row">
                  <div className="lp-bt-check lp-bt-check-on"></div>
                  <div className="lp-bt-name">DoorDash Credit</div>
                  <span className="lp-bt-tag lp-bt-tag-dining">Dining</span>
                  <div className="lp-bt-value">$300/yr</div>
                </div>
                <div className="lp-bt-row">
                  <div className="lp-bt-check lp-bt-check-on"></div>
                  <div className="lp-bt-name">$10 Lyft Credit</div>
                  <span className="lp-bt-tag lp-bt-tag-travel">Travel</span>
                  <div className="lp-bt-value">$120/yr</div>
                </div>
                <div className="lp-bt-row">
                  <div className="lp-bt-check lp-bt-check-on"></div>
                  <div className="lp-bt-name">Global Entry / TSA PreCheck</div>
                  <span className="lp-bt-tag lp-bt-tag-travel">Travel</span>
                  <div className="lp-bt-value">$120/yr</div>
                </div>
                <div className="lp-bt-row">
                  <div className="lp-bt-check"></div>
                  <div className="lp-bt-name">$500 The Edit Hotel Credit</div>
                  <span className="lp-bt-tag lp-bt-tag-travel">Travel</span>
                  <div className="lp-bt-value">$500/yr</div>
                </div>
                <div className="lp-bt-row">
                  <div className="lp-bt-check"></div>
                  <div className="lp-bt-name">Priority Pass Lounge</div>
                  <span className="lp-bt-tag lp-bt-tag-travel">Travel</span>
                  <div className="lp-bt-value">Included</div>
                </div>
              </div>
            </div>
          </div>

          {/* Feature 2: Decision Tools */}
          <div className="lp-feature-row lp-feature-row-reverse">
            ...
            <div className="lp-feature-visual">
              <div className="lp-feature-screenshot">
                <div className="lp-dt-row">
                  <div className="lp-dt-icon lp-dt-icon-green">
                  ...
                  <div>
                    <div className="lp-dt-label">Beyond the Numbers</div>
                    <div className="lp-dt-sub">Transfer partners, insurance, status perks &amp; more</div>
                  </div>
                  <div className="lp-dt-arrow">&rsaquo;</div>
                </div>
                <div className="lp-dt-row">
                  <div className="lp-dt-icon lp-dt-icon-green">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><rect x="5" y="2" width="14" height="20" rx="2"/><line x1="12" y1="18" x2="12.01" y2="18"/></svg>
                  </div>
                  <div>
                    <div className="lp-dt-label">Retention Offers</div>
                    <div className="lp-dt-sub">Call before you cancel — most people get an offer</div>
                  </div>
                  <div className="lp-dt-arrow">&rsaquo;</div>
                </div>
                <div className="lp-dt-row">
                  <div className="lp-dt-icon lp-dt-icon-red">
                  ...
                  <div>
                    <div className="lp-dt-label">If You Cancel</div>
                    <div className="lp-dt-sub">What you'll lose and what happens to your points</div>
                  </div>
                  <div className="lp-dt-arrow">&rsaquo;</div>
                </div>
                <div className="lp-dt-row">
                  <div className="lp-dt-icon lp-dt-icon-green">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><polyline points="6 9 12 15 18 9"/></svg>
                  </div>
                  <div>
                    <div className="lp-dt-label">Downgrade Options</div>
                    <div className="lp-dt-sub">3 product changes available &middot; No hard pull</div>
                  </div>
                  <div className="lp-dt-arrow">&rsaquo;</div>
                </div>
                <div className="lp-dt-row">
                  <div className="lp-dt-icon lp-dt-icon-green">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M1 4v6h6"/><path d="M23 20v-6h-6"/><path d="M20.49 9A9 9 0 0 0 5.64 5.64L1 10M23 14l-4.64 4.36A9 9 0 0 1 3.51 15"/></svg>
                  </div>
                  <div>
                    <div className="lp-dt-label">Recommended Replacement</div>
                    <div className="lp-dt-sub">Amex Platinum &middot; +$2,034 net value</div>
                  </div>
                  <div className="lp-dt-arrow">&rsaquo;</div>
                </div>
              </div>
          ...
          <div className="lp-feature-row">
            ...
            <div className="lp-feature-visual">
              <div className="lp-feature-screenshot">
                <div className="lp-fs-header">
                  <div className="lp-fs-icon">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M3 12l2-2m0 0l7-7 7 7m-14 0v8a1 1 0 0 0 1 1h3m10-9l2 2m-2-2v8a1 1 0 0 1-1 1h-3m-6 0a1 1 0 0 1-1-1v-4a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v4a1 1 0 0 1-1 1m-4 0h4"/></svg>
                  </div>
                  <div>
                    <div className="lp-fs-title">Fee Dashboard</div>
                    <div className="lp-fs-subtitle">6 cards (household) &middot; 4 with annual fees</div>
                  </div>
                </div>
                <div className="lp-sim-metrics" style={{marginBottom:20}}>
                  <div className="lp-sim-metric">
                    <div className="lp-sim-metric-label">Total Fees</div>
                    <div className="lp-sim-metric-value lp-sim-metric-value-fee" style={{fontSize:'1.3rem'}}>$1,080</div>
                  </div>
                  <div className="lp-sim-metric">
                    <div className="lp-sim-metric-label">Credits</div>
                    <div className="lp-sim-metric-value lp-sim-metric-value-credits" style={{fontSize:'1.3rem'}}>$4,196</div>
                  </div>
                  <div className="lp-sim-net-box">
                    <div className="lp-sim-metric-label">Net ROI</div>
                    <div className="lp-sim-metric-value lp-sim-metric-value-net" style={{fontSize:'1.3rem'}}>+$3,116</div>
                  </div>
                </div>
                <div className="lp-hh-timeline-label">Renewal Timeline</div>
                <div className="lp-bt-row">
                  <div className="lp-hh-bar lp-hh-bar-you"></div>
                  <div className="lp-bt-name">Sapphire Reserve <span className="lp-hh-tag lp-hh-tag-you">YOU</span></div>
                  <div className="lp-bt-value">$795/yr</div>
                </div>
                <div className="lp-bt-row">
                  <div className="lp-hh-bar lp-hh-bar-partner"></div>
                  <div className="lp-bt-name">Hyatt Card <span className="lp-hh-tag lp-hh-tag-partner">PARTNER</span></div>
                  <div className="lp-bt-value">$95/yr</div>
                </div>
                <div className="lp-bt-row">
                  <div className="lp-hh-bar lp-hh-bar-you"></div>
                  <div className="lp-bt-name">Bilt Obsidian <span className="lp-hh-tag lp-hh-tag-you">YOU</span></div>
                  <div className="lp-bt-value">$95/yr</div>
                </div>
              </div>
            </div>
        ...
        <div className="lp-container">
          ...
          <div className="lp-steps-grid">
            <div className="lp-step">
              ...
              <div className="lp-step-title">Add your cards</div>
              <div className="lp-step-desc">Select your credit cards from our database of 100+ cards with pre-loaded benefits.</div>
            </div>
            <div className="lp-step">
              <div className="lp-step-number">2</div>
              <div className="lp-step-title">Check off what you use</div>
              <div className="lp-step-desc">Mark the benefits you actually redeem. Your real ROI updates instantly.</div>
            </div>
            <div className="lp-step">
              <div className="lp-step-number">3</div>
              <div className="lp-step-title">Get your verdict</div>
              <div className="lp-step-desc">See whether to keep, cancel, downgrade, or switch — with the exact options to do it.</div>
            </div>
          </div>
        </div>
      </section>
